...
test("four players form teams and start the tournament", async ({ browser }) => {
  ...
  await firstWeightSlider.press("End")
  await expect(guests[0].locator("output").getByText("250 g", { exact: true })).toBeVisible()
  await guests[0].getByRole("button", { name: "Valider la réponse" }).click()
  ...
  await secondWeightSlider.press("End")
  ...
  await thirdWeightSlider.press("End")
